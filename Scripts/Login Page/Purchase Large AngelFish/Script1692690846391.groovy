...
WebUI.verifyElementText(findTestObject('Object Repository/Page_JPetStore Demo/div_Welcome Emids'), 'Welcome Emids!')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_JPetStore Demo/td_LargeAngelfish'), 'Large Angelfish')
